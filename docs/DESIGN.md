...
> Design notes for **scheduled-job-failure-surface** — a runnable go example that Capture scheduled logistics job failures with a small Go HTTP client.
...
- **Feature code** — the actual task: logistics job monitoring.
